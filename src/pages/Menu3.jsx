...
return (
    <>
        ...
        <div className='encabezado parte_izquierda'>
            ...
            <p>- Nachos with Chili <strong>$280</strong></p>
            <p>- Tlacoyos (Order of 3pz) <strong>$60</strong>. With chicken <strong>+$50</strong>, with beef jerky <strong>+$60</strong>, with arrachera <strong>+$80</strong></p>
            <p>- Sopes (Order of 3pz) <strong>$90</strong>. With chicken <strong>+$50</strong>, with beef jerky <strong>+$60</strong>, with arrachera <strong>+$80</strong></p>
            ...
            <p>- Enchiladas (Green or Red). <strong>$180</strong></p>
            ...
            <p>- Potatoe Flautas <strong>$120</strong></p>
            <p>- Mushroom Stuffed Enchiladas (Green or Red) <strong>$180</strong></p><hr/>
            <h3>Every Thursday and Friday</h3>
            <p>- Pozole <strong>$180</strong></p>
            <img src='images/gusano-hoja.WEBP'/><hr/>
            <h3>Every Saturday and Sunday</h3>
            <p>- Barbacoa Taco <strong>$45</strong></p>
            <p>- Barbacoa on Green Sauce with Nopales Taco <strong>$55</strong></p>
            <p>- Chilaquiles with Barbacoa <strong>$180</strong></p>
            <p>- Pancita Taco <strong>$55</strong></p>
            <p>- Barbacoa Flautas (Orden de 3pz) <strong>$150</strong></p>
            <p>- Barbacoa Quesadilla <strong>$150</strong></p>
            ...
            <p>- Water of the Day <strong>$45</strong></p>
            <p>- Boing <strong>$45</strong></p>
            <p>- Green Juice <strong>$90</strong></p>
